...
**API Base URL**: `https://tajiri.zimasystems.com/api`
**Storage URL**: `https://tajiri.zimasystems.com/storage`
**Server**: `172.240.241.180` (Laravel at `/var/www/tajiri.zimasystems.com`)
...
**Files**: `lib/services/api_service.dart`, `lib/config/api_config.dart`
