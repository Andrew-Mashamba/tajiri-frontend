# Kimi Memory System for TAJIRI

This directory contains persistent memory for Kimi Code CLI to maintain context across sessions.
...
Migrated from `.claude/memory/` on 2026-04-29
