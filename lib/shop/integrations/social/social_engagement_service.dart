// Blueprint: docs/shop/shop.md — services/SocialEngagementShopBridge
import '../../integrations/shop_extended_api.dart';
import '../../data/repositories/shop_repository.dart';

class SocialEngagementShopBridge {
  SocialEngagementShopBridge({ShopExtendedApi? api, ShopRepository? repo})
