// Blueprint: docs/shop/shop.md — services/ShopPushNotificationService
import '../../integrations/shop_extended_api.dart';
import '../../data/repositories/shop_repository.dart';

class ShopPushNotificationService {
  ShopPushNotificationService({ShopExtendedApi? api, ShopRepository? repo})
