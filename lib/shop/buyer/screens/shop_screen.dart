...
class _ShopScreenState extends State<ShopScreen> {
  ...
  Future<void> _loadCartCount() async {
    ...
    if (!mounted) return;
    CartProvider.instance.ingestCartSnapshot(
      result,
                ...
                actions: [
                  PopupMenuButton<String>(
                    ...
                    onSelected: (value) {
                      ...
                      switch (value) {
                        case 'rec':
                          Navigator.pushNamed(context, '/shop/recommended',
                              arguments: {'currentUserId': uid});
                          break;
                        case 'near':
                          Navigator.pushNamed(context, '/shop/nearby',
                              arguments: {'currentUserId': uid});
                          break;
                        case 'hist':
                          Navigator.pushNamed(context, '/shop/recently-viewed');
                          break;
                        case 'search':
                          ...
                          break;
                        case 'trend':
                          Navigator.pushNamed(context, '/shop/trending',
                              arguments: {'currentUserId': uid});
                          break;
                        case 'msg':
                          Navigator.pushNamed(context, '/shop/seller-inbox');
                          break;
                        case 'all':
                          Navigator.pushNamed(context, '/shop/features');
                          break;
                      }
                    },
                    itemBuilder: (ctx) => const [
                      PopupMenuItem(value: 'rec', child: Text('Recommended')),
                      PopupMenuItem(value: 'near', child: Text('Nearby')),
                      PopupMenuItem(value: 'hist', child: Text('Recently viewed')),
                      PopupMenuItem(value: 'search', child: Text('Search')),
                      PopupMenuItem(value: 'trend', child: Text('Trending')),
                      PopupMenuItem(value: 'msg', child: Text('Messages')),
                      PopupMenuItem(value: 'all', child: Text('All shop features')),
                    ],
                  ),
                  IconButton(
