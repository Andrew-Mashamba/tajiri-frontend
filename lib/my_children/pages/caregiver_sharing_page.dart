// lib/my_children/pages/caregiver_sharing_page.dart
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              // Missing 54: Co-parent role
              _RoleOption(
                label: sw ? 'Mzazi Mwenza' : 'Co-Parent',
                subtitle: sw
                    ? 'Upatikanaji kamili sawa na wako'
                    : 'Full access equal to yours',
                isSelected: _selectedRole == 'co_parent',
                onTap: () => setState(() => _selectedRole = 'co_parent'),
              ),
              const SizedBox(height: 8),
              // Missing 56: Doctor access
              _RoleOption(
              ...
              const SizedBox(height: 8),
              // Missing 57: School access
              _RoleOption(
                label: sw ? 'Shule' : 'School',
                subtitle: sw
                    ? 'Mahudhurio na taarifa za afya'
                    : 'Attendance and health info',
                isSelected: _selectedRole == 'school',
                onTap: () => setState(() => _selectedRole = 'school'),
              ),
            ],
          ),
        ),
...
class _CaregiverTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (caregiver.role) {
      ...
      case 'co_parent':
        roleBadge = isSwahili ? 'Mzazi Mwenza' : 'Co-Parent';
      case 'doctor':
        roleBadge = isSwahili ? 'Daktari' : 'Doctor';
      case 'school':
        roleBadge = isSwahili ? 'Shule' : 'School';
      default:
        roleBadge = isSwahili ? 'Mlezi' : 'Caregiver';
    }
    final name =
