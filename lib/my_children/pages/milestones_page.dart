// lib/my_children/pages/milestones_page.dart
...
const List<_LocalMilestone> _allMilestones = [
  ...
  // ─── Toddler Milestones (24-60 months) ─────────────────────────
  // Month 24
  _LocalMilestone(month: 24, titleEn: 'Runs well', titleSw: 'Anakimbia vizuri', category: MilestoneCategory.motor),
  _LocalMilestone(month: 24, titleEn: 'Kicks a ball', titleSw: 'Anapiga mpira kwa mguu', category: MilestoneCategory.motor),
  _LocalMilestone(month: 24, titleEn: 'Uses 50+ words', titleSw: 'Anatumia maneno 50+', category: MilestoneCategory.language),
  _LocalMilestone(month: 24, titleEn: 'Makes 2-word phrases', titleSw: 'Anaunda sentensi za maneno 2', category: MilestoneCategory.language),
  _LocalMilestone(month: 24, titleEn: 'Parallel play with others', titleSw: 'Anacheza karibu na watoto wengine', category: MilestoneCategory.social),
  // Month 30
  _LocalMilestone(month: 30, titleEn: 'Jumps with both feet', titleSw: 'Anaruka kwa miguu yote', category: MilestoneCategory.motor),
  _LocalMilestone(month: 30, titleEn: 'Speaks in sentences', titleSw: 'Anazungumza kwa sentensi', category: MilestoneCategory.language),
  _LocalMilestone(month: 30, titleEn: 'Names colors', titleSw: 'Anataja rangi', category: MilestoneCategory.cognitive),
  _LocalMilestone(month: 30, titleEn: 'Begins sorting shapes', titleSw: 'Anaanza kupanga maumbo', category: MilestoneCategory.cognitive),
  // Month 36
  _LocalMilestone(month: 36, titleEn: 'Rides a tricycle', titleSw: 'Anapanda baiskeli ya gurudumu tatu', category: MilestoneCategory.motor),
  _LocalMilestone(month: 36, titleEn: 'Draws a circle', titleSw: 'Anachora duara', category: MilestoneCategory.motor),
  _LocalMilestone(month: 36, titleEn: 'Asks "why?" frequently', titleSw: 'Anauliza "kwa nini?" mara kwa mara', category: MilestoneCategory.cognitive),
  _LocalMilestone(month: 36, titleEn: 'Engages in pretend play', titleSw: 'Anacheza michezo ya kujifanya', category: MilestoneCategory.social),
  _LocalMilestone(month: 36, titleEn: 'Takes turns with others', titleSw: 'Anabadilishana zamu na wengine', category: MilestoneCategory.social),
  // Month 48
  _LocalMilestone(month: 48, titleEn: 'Hops on one foot', titleSw: 'Anaruka kwa mguu mmoja', category: MilestoneCategory.motor),
  _LocalMilestone(month: 48, titleEn: 'Counts to 10', titleSw: 'Anahesabu hadi 10', category: MilestoneCategory.cognitive),
  _LocalMilestone(month: 48, titleEn: 'Tells stories', titleSw: 'Anasimulia hadithi', category: MilestoneCategory.language),
  _LocalMilestone(month: 48, titleEn: 'Dresses self', titleSw: 'Anavaa peke yake', category: MilestoneCategory.motor),
  _LocalMilestone(month: 48, titleEn: 'Plays cooperatively', titleSw: 'Anacheza kwa kushirikiana', category: MilestoneCategory.social),
  // Month 60
  _LocalMilestone(month: 60, titleEn: 'Skips', titleSw: 'Anaruka kamba', category: MilestoneCategory.motor),
  _LocalMilestone(month: 60, titleEn: 'Writes own name', titleSw: 'Anaandika jina lake', category: MilestoneCategory.motor),
  _LocalMilestone(month: 60, titleEn: 'Uses complex sentences', titleSw: 'Anatumia sentensi ngumu', category: MilestoneCategory.language),
  _LocalMilestone(month: 60, titleEn: 'Shows empathy', titleSw: 'Anaonyesha huruma', category: MilestoneCategory.social),
  _LocalMilestone(month: 60, titleEn: 'Understands time concepts', titleSw: 'Anaelewa dhana za wakati', category: MilestoneCategory.cognitive),
];
...
class _MilestonesPageState extends State<MilestonesPage> {
  ...
  Future<void> _loadMilestones() async {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Fire-and-forget: schedule monthly milestone alert
        _scheduleMilestoneAlert();
      } else {
        setState(() {
  ...
  /// Fire-and-forget: schedule a monthly milestone check reminder.
  void _scheduleMilestoneAlert() {
    try {
      final ageMonths = DateTime.now().difference(widget.baby.dateOfBirth).inDays ~/ 30;
      ChildrenNotificationHelper.scheduleMilestoneMonthlyAlert(
        widget.baby.id,
        widget.baby.name,
        ageMonths,
        isSwahili: _sw,
                ...
                : RefreshIndicator(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        if (_hasDelayedMilestones && _currentUserId != null)
                          _buildCrossModuleLink(
                            icon: Icons.local_hospital_rounded,
                            label: sw
                                ? 'Fikiria kuzungumza na daktari wako'
                        ...
                        _buildCrossModuleLink(
                          ...
                          label: sw
                              ? 'Uliza Shangazi kuhusu shughuli za kukuza ukuaji'
                              : 'Ask Shangazi about activities to encourage development',
                        ...
                        if (_currentUserId != null)
                          _buildCrossModuleLink(
                            ...
                            label: sw
                                ? 'Shiriki hatua hii na jamii'
                                : 'Share this milestone with the community',
                            onTap: () => Navigator.push(context,
                                MaterialPageRoute(builder: (_) => CommunityModule(userId: _currentUserId!))),
                          ),
  ...
  bool get _hasDelayedMilestones =>
      _allMilestones.any((m) => _isDelayed(m));
