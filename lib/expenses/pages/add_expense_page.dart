...
class _AddExpensePageState extends State<AddExpensePage> {
  ...
  String _categoryLabel(ExpenseCategory c, {bool isSwahili = false}) {
    switch (c) {
      ...
      case ExpenseCategory.communication:
        return isSwahili ? 'Mawasiliano' : 'Comms';
      case ExpenseCategory.maintenance:
        return isSwahili ? 'Matengenezo' : 'Repairs';
      case ExpenseCategory.tax:
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: Text(isSwahili ? 'Chagua kutoka Galari' : 'Choose from Gallery'),
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(sw ? 'Imeshindikana kuchagua picha' : 'Could not pick image')));
      }
    }
  }
  ...
  Future<void> _save() async {
    ...
    if (amount <= 0) {
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(isSwahili ? 'Weka kiasi halisi' : 'Enter a valid amount')));
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        ...
        if (res.success) {
          ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text(sw ? 'Matumizi yameongezwa!' : 'Expense added!')));
      ...
      if (mounted) {
        ...
        final sw = AppStringsScope.of(context)?.isSwahili ?? false;
        ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(sw ? 'Hitilafu ya mtandao' : 'Connection error')));
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(isSwahili ? 'Ongeza Matumizi' : 'Add Expense',
      ...
      body: ListView(
        ...
        children: [
          // Amount
          Text(isSwahili ? 'Kiasi (TZS)' : 'Amount (TZS)',
              style: const TextStyle(
                  fontSize: 14,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        _categoryLabel(c, isSwahili: isSwahili),
                  ...
                  : Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text(
                            isSwahili ? 'Piga picha ya risiti' : 'Take a photo of the receipt',
                            style: const TextStyle(
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText: isSwahili ? 'Jina la Muuzaji / Duka' : 'Vendor / Shop Name',
              filled: true,
              fillColor: _kCardBg,
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(10),
          ...
          // Payment method
          Text(isSwahili ? 'Njia ya Malipo' : 'Payment Method',
              style: const TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w600,
                  color: _kPrimary)),
          ...
          Row(
            children: [
              _paymentChip('cash', isSwahili ? 'Taslimu' : 'Cash', Icons.money_rounded),
              const SizedBox(width: 10),
              _paymentChip(
                  'mpesa', 'M-Pesa', Icons.phone_android_rounded),
              const SizedBox(width: 10),
              _paymentChip(
                  'bank', isSwahili ? 'Benki' : 'Bank', Icons.account_balance_rounded),
            ],
          ),
          ...
          TextField(
            ...
            maxLines: 2,
            decoration: InputDecoration(
              labelText: isSwahili ? 'Maelezo ya ziada' : 'Additional notes',
              filled: true,
              fillColor: _kCardBg,
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(10),
