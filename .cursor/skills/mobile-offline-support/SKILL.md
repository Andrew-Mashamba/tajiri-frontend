...
description: Implement offline-first mobile apps with local storage, sync strategies, and conflict resolution. Covers Hive, local caching, media cache, resumable uploads, and background sync patterns for TAJIRI.
triggers:
  - offline
  - offline-first
  - cache
