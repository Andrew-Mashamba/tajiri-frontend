---
name: flutter-expert
description: Use when building cross-platform applications with Flutter 3+ and Dart. Invoke for widget development, state management, navigation, platform-specific implementations, performance optimization, media handling, audio/video playback.
triggers:
  - Flutter
  - Dart
  - widget
